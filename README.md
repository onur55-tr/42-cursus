...
7. [Introduction](#introduction)
    - [Step 1: What is the difference between Apt vs Aptitute](#apt-aptitute)
    - [Step 2: What is a VM?](#what-is-vm)
    - [Step 3: How do VM work?](#how-to-vm-work)
    - [Step 4: What is LVM?](#what-is-lvm)
    - [Step 5: What is AppArmor?](#what-is-apparmor)
    - [Step 7: How to use SSH](#how-to-use-ssh)
    - [Step 8: How to implement UFW with SSH?](#ufw-with-ssh)
    - [Step 9: What is cron and what is wall?](#cron-what-is-wall)
...
### Step 2: Virtual Machine Work
    
irtualization allow us share a system with multiple virtual environments. The hypervisor manages the hardware system and separate the physical resources from the virtual environments. **The resources are managed followitn the needs, from the host to the guests.** When an user from a VM do a task that requires additional resources from the physical environment, the hypervisor manages the request so that the guest OS could access the resources of the physical environment.<br>
